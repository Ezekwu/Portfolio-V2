...
export default function Hero() {
  ...
  return (
    <div  
    id="home"
    className='hero md:min-h-screen md:max-h-[1400px] mx-auto! pt-20! flex relative z-10'
    >
      <div >
      ...
      <div ref={herocontentRef} className="hero-content max-w-[650px] mx-auto relative z-50">
        <div className="gradient-text text-sm md:text-[18px] font-grotesk font-normal flex gap-2 items-center justify-center">
          ...
          <h1 className=" text-[1.8rem]  sm:text-[2rem] md:text-[3rem] xl:text-[4rem] leading-[120%] font-normal gradient-text mb-5 font-sora">Ezekwu Jeremiah <br /> Frontend Engineer</h1>
